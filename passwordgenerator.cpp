...
void generate_password(int length)
{
    ...
    while (count < length) 
    {
        ...
        // and will be used to select one of the above-defined strings
        // (i.e., alphabet or ALPHABET or s_symbol or number)
        // 1 is for the string alphabet
        // 2 is for the string ALPHABET
        // 3 is for the string number
        // and 4 is for the string s_symbol
        ...
        // ALPHABET (i.e., 1 or 2).
        // The following if condition will take care of it.
        if (count == 0) {
            k = k % 2 + 1;
        }
        ...
        switch (k) 
        {
            ...
            case 3:
                ...
                // In case it has been fulfilled and the minimum requirements of
                // other characters are still left, then it will break.
                if (count_number == 1 && (count_alphabet == 0 || count_ALPHABET == 1 || count_s_symbol == 0))
                    break;
            ...
            case 4:
                ...
                // In case it has been fulfilled and the minimum requirements of
                // other characters are still left, then it will break.
                if (count_s_symbol == 1 && (count_alphabet == 0 || count_ALPHABET == 1 || count_number == 0))
                    break;
